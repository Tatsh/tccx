...
html_theme_options = {
    ...
    'repo_name': 'tccx',
    'repo_url': 'https://github.com/Tatsh/tccx',
    'site_url': 'https://tccx.readthedocs.io',
    'toc_title_is_page_title': True
}
intersphinx_mapping = {'python': ('https://docs.python.org/3', None)}
# Only the CLI reference becomes a man page (`gen-manpage`).
man_pages = [('tcc-preapprove', 'tcc-preapprove', 'pre-approve macOS TCC permissions', authors, 1)]
